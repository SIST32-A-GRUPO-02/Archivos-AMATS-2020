<!DOCTYPE html>
 ...
 <body>
   <div style="margin-bottom: 5px; margin-left:16px;">
     ...
     <a href="../pdf/evaluacionespdf.php" class="btn btn-danger">Reportes</a>
       ...
       <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:700px">
         ...
         <form class="w3-container" method="post" action="mant_evaluaciones.php">
           <div class="w3-section">
             ...
             <input class="w3-input w3-border " type="text" placeholder="Escriba el nombre de la Evaluación" name="nombre" required>
             <label><b>Porcentaje</b></label>
             <input class="w3-input w3-border" type="text" placeholder="Escriba el porcentaje de la evaluación" name="porcentaje" required>
