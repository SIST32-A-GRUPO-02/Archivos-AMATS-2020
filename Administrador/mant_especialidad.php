...
if (isset($_POST['send_insert'])) {
  ...
  echo " <script>window.location.replace('./index.php?x=especialidad.php')</script>";
  ...
  $conn->borrar("especialidad", "idEspecialidad = $id_del");
  //Mensaje de INGRESO a DB(No valida si la consulta fue exitosa)
...
<!-- Activar el MODAL al CARGAR el sitio completo -->
    ...
    <div id="id01" class="w3-modal">
      <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:700px">
        <div class="w3-center"><br>
          <a href="index.php?x=especialidad.php"> <span class="w3-button w3-xlarge w3-hover-red w3-display-topright" title="Close Modal">&times;</span></a>
        ...
        <form class="w3-container" method="post" action="">
          <div class="w3-section">
            ...
            $busqueda = $conn->busquedaFree("SELECT * FROM especialidad WHERE idEspecialidad = $id_update");
        ...
        <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
          <a href="index.php?x=especialidad.php" class="w3-button w3-red">Cancel</a>
        </div>
      </div>
    </div>
    <!-- FIN del MODAL -->
  ...
  $consulta = $conn->actualizar("especialidad","nombreEspecialidad='$nombreEspe'","idEspecialidad=$id_update");
