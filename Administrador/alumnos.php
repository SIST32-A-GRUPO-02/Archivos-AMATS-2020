            ...
            <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:700px">
                ...
                <form class="w3-container" method="post" action="mant_alumnos.php">
                    <div class="w3-section">
                        ...
                        <input class="w3-input w3-border " type="text" placeholder="Escriba el Nombre" name="nombre"
                            required>
                        <label><b>Apellido</b></label>
                        <input class="w3-input w3-border" type="text" placeholder="Escriba los Apellidos"
                            name="apellido" required>
                        <label><b>Telefono celular</b></label>
                        <input class="w3-input w3-border" type="text" placeholder="Escriba el Telefono"
                            name="telefono_personal" id="telp" required>
                        <label><b>Telefono fijo</b></label>
                        <input class="w3-input w3-border" type="text" placeholder="Escriba el Telefono"
                            name="telefono_fijo" id="telc" required>
