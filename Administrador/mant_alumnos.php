        ...
        <form class="w3-container" method="post" action="">
          ...
          ON (
            ...
            ?>
              ...
              if ($idtelefono == '1') {
                echo '<input class="w3-input w3-border" type="text" value="'.$numeroTelefono.'" name="telefono_personal" id="telp" required>';
              }else{
                echo '<label><b>Telefono Celular</b></label>
                <input class="w3-input w3-border" type="text" value="'.$numeroTelefono.'" name="telefono_fijo" id="telc" required>';
              }}
              ?>
