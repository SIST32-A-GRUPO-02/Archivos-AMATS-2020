<!DOCTYPE html>
 ...
 <body>
   <div style="margin-bottom: 5px; margin-left:16px;">
     ...
     <a href="../pdf/modulospdf.php" class="btn btn-danger">Reportes</a>
       ...
       <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:700px">
         ...
         <form class="w3-container" method="post" action="mant_modulos.php">
           <div class="w3-section">
             ...
             <input class="w3-input w3-border " type="text" placeholder="Escriba el nombre del módulo" name="nombre" required>
             <label><b>Descripción del módulo</b></label>
             <input class="w3-input w3-border" type="text" placeholder="Escriba una descripción del módulo" name="descripcion" required>
             <label><b>Horas del modulo</b></label>
             <input class="w3-input w3-border" type="number" min="1"  placeholder="Escriba la duración en horas del módulo" name="horas" required>
